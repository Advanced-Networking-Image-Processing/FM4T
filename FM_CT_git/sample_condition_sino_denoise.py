...
parser.add_argument('--task_config', default="configs/tasks/denoising_config_512_gauss_p2.yaml", type=str)
parser.add_argument('--gpu', type=int, default=0)
parser.add_argument('--save_dir', type=str, default='./results_512/sinogram/six_samples_smc/pixel_p33_latent_p33/denoise_gauss_0.2/May21_25')
