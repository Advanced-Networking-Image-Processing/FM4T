...
parser.add_argument('--task_config', default="configs/tasks/denoising_config_512_gauss_p1.yaml", type=str)
parser.add_argument('--gpu', type=int, default=0)
parser.add_argument('--save_dir', type=str, default='./results_512/sinogram/samples_psmc/p1e_4_pg20/LDM_fine_tuned_admm_not_matched/denoise/p1')
