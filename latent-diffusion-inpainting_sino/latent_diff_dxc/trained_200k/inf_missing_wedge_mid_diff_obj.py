...
for ii in range(len(fr_smb)):
    ...
    for jj in range(len(spr_sam)):
        ...
        dxchange.write_tiff(image_dxc, 'fine_tuned_20k/Missing_Wedge_mid_blck/diff_size_obj/' + smb[ii] + '_obj/' + 'mask_' + str(spr_samk[jj]) + '/org_image' + str(fr_smb[ii]), dtype='float32', overwrite=True)
        dxchange.write_tiff(mi_dxc, 'fine_tuned_20k/Missing_Wedge_mid_blck/diff_size_obj/' + smb[ii] + '_obj/' + 'mask_' + str(spr_samk[jj]) + '/masked_org_image' + str(fr_smb[ii]), dtype='float32', overwrite=True)
        dxchange.write_tiff(o_dxc, 'fine_tuned_20k/Missing_Wedge_mid_blck/diff_size_obj/' + smb[ii] + '_obj/' + 'mask_' + str(spr_samk[jj]) + '/output_image' + str(fr_smb[ii]), dtype='float32', overwrite=True)

        #dxchange.write_tiff(image_dxc, 'fine_tuned_20k/Missing_Wedge_mid_blck/10degs/org_image' + str(i), dtype='float32', overwrite=True)
        #dxchange.write_tiff(mi_dxc, 'fine_tuned_20k/Missing_Wedge_mid_blck/10degs/masked_org_image' + str(i), dtype='float32', overwrite=True)
        #dxchange.write_tiff(o_dxc, 'fine_tuned_20k/Missing_Wedge_mid_blck/10degs/output_image' + str(i), dtype='float32', overwrite=True)
