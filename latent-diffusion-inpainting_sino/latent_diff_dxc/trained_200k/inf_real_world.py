...
model_path = "../../logs/checkpoints/epoch_400.ckpt"
...
def generate_sino_mask(load_image_i):
    ...
    sixty_percnt = random.sample(range(im_size[0]), prcnt)
...
#i = 4
#data_path = "../../sino_data/512x512/data/sino/diff_size_obj/ds-simu-test_sino_20_medium.h5"
#load_image = h5py.File(data_path, 'r')["sino"]
data_path = "/homes/sruban/latent-diffusion-inpainting_sino_trial/real_world_data/Jiaze/tomo_00068/sino_00068_prj25_resc.tiff"
load_image_i = dxchange.read_tiff(data_path)
print('load_image_i', load_image_i.shape)
print('load_image_i min and max', np.min(load_image_i), np.max(load_image_i))

image, mask = generate_sino_mask(load_image_i)
...
dxchange.write_tiff(image_dxc, 'random_masking/real_world_data/tomo_00068/prj25/masked_p6/org_image', dtype='float32', overwrite=True)
dxchange.write_tiff(mi_dxc, 'random_masking/real_world_data/tomo_00068/prj25/masked_p6/masked_org_image', dtype='float32', overwrite=True)
dxchange.write_tiff(o_dxc, 'random_masking/real_world_data/tomo_00068/prj25/masked_p6/output_image', dtype='float32', overwrite=True)
