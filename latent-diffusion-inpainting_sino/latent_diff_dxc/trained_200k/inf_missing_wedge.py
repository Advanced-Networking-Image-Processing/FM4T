...
dxchange.write_tiff(image_dxc, 'fine_tuned_20k/Missing_Wedge/10degs/org_image' + str(i), dtype='float32', overwrite=True)
dxchange.write_tiff(mi_dxc, 'fine_tuned_20k/Missing_Wedge/10degs/masked_org_image' + str(i), dtype='float32', overwrite=True)
dxchange.write_tiff(o_dxc, 'fine_tuned_20k/Missing_Wedge/10degs/output_image' + str(i), dtype='float32', overwrite=True)
