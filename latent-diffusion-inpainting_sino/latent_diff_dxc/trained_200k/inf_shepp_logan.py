...
data_path = "/homes/sruban/latent-diffusion-inpainting_sino_trial/sino_data/512x512/data/tomopy_phantoms/shepp2D/sino.tiff"
load_image_i = dxchange.read_tiff(data_path)[0]
...
dxchange.write_tiff(image_dxc, 'random_masking/shepp_logan/masked_p3/org_image', dtype='float32', overwrite=True)
dxchange.write_tiff(mi_dxc, 'random_masking/shepp_logan/masked_p3/masked_org_image', dtype='float32', overwrite=True)
dxchange.write_tiff(o_dxc, 'random_masking/shepp_logan/masked_p3/output_image', dtype='float32', overwrite=True)
