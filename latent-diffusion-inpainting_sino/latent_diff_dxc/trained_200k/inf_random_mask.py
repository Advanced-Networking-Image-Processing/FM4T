...
def generate_sino_mask(load_image_i):
    ...
    sixty_percnt = random.sample(range(im_size[0]), 51)
...
dxchange.write_tiff(image_dxc, 'random_masking/diff_size_obj/medium_obj/masked_p1/org_image' + str(i), dtype='float32', overwrite=True)
dxchange.write_tiff(mi_dxc, 'random_masking/diff_size_obj/medium_obj/masked_p1/masked_org_image' + str(i), dtype='float32', overwrite=True)
dxchange.write_tiff(o_dxc, 'random_masking/diff_size_obj/medium_obj/masked_p1/output_image' + str(i), dtype='float32', overwrite=True)
