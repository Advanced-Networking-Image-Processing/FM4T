...
model_path = "../../logs_20k_Spr_Rec/checkpoints/epoch_575.ckpt"
...
dxchange.write_tiff(image_dxc, 'fine_tuned_20k/Spr_Rec/f_2/org_image' + str(i), dtype='float32', overwrite=True)
dxchange.write_tiff(mi_dxc, 'fine_tuned_20k/Spr_Rec/f_2/masked_org_image' + str(i), dtype='float32', overwrite=True)
dxchange.write_tiff(o_dxc, 'fine_tuned_20k/Spr_Rec/f_2/output_image' + str(i), dtype='float32', overwrite=True)
