...
def compute_gt_gradient(x_start, y_start, source_img, target_img, mask, gpu_id):
    ...
    red_foreground_gradient = red_source_gradient
    ...
    green_foreground_gradient = green_source_gradient
    ...
    blue_foreground_gradient = blue_source_gradient
