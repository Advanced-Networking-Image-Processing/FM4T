...
from ldm.ldm.data import PIL_data_20k_Spr_Rec
...
class CUDACallback(Callback):
    ...
    #def on_train_epoch_end(self, trainer_pl_module, outputs): is throwing error. Need to delete the last input to the function.
...
if __name__ == "__main__":
    ...
    try:
        ...
        if opt.stage == str(0):
            dataSet = PIL_data_20k_Spr_Rec.InpaintingTrain_autoencoder(img_size,path)

        if opt.stage == str(1):
            dataSet = PIL_data_20k_Spr_Rec.InpaintingTrain_ldm(img_size,path)
