...
from ldm.ldm.data import PIL_data_20k_MW
...
if __name__ == "__main__":
    ...
    try:
        ...
        if opt.stage == str(0):
            dataSet = PIL_data_20k_MW.InpaintingTrain_autoencoder(img_size,path)

        if opt.stage == str(1):
            dataSet = PIL_data_20k_MW.InpaintingTrain_ldm(img_size,path)
