...
model_path = "logs/checkpoints/epoch_55.ckpt"
...
def generate_sino_mask(load_image_i):
    ...
    sixty_percnt = random.sample(range(im_size[0]), 461)
...
i = 10
data_path = "sino_data/512x512/data/sino/ds-simu-test-sino_100.h5"
...
dxchange.write_tiff(image_dxc, 'latent_diff_dxc/masked_p9/ep55/org_image' + str(i), dtype='float32', overwrite=True)
dxchange.write_tiff(mi_dxc, 'latent_diff_dxc/masked_p9/ep55/masked_org_image' + str(i), dtype='float32', overwrite=True)
dxchange.write_tiff(o_dxc, 'latent_diff_dxc/masked_p9/ep55/output_image' + str(i), dtype='float32', overwrite=True)
