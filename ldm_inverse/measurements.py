...
@register_operator(name='CT_recon')
class GaussialBlurOperator(LinearOperator):
    def __init__(self, kernel_size, intensity, device):
        self.device = device
        '''
    ...
    def forward(self, data, **kwargs):
        ...
        #data_sino = ct_parallel_project_2d_batch(data.permute(0,2,3,1), angles)
        #print('data_sino shape', data_sino.shape)
        return data
...
class InpaintingOperator(LinearOperator):
    ...
    def forward(self, data, **kwargs):
        try:
            #print(data.shape)
            #print(kwargs.get('mask', None).shape)
