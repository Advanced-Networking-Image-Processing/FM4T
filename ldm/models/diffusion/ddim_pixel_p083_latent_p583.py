...
class DDIMSampler(object):
    ...
    def posterior_sampler(self, measurement, measurement_cond_fn, operator_fn,
        ...
        print('I am in line #158 of DDIM.py')
        self.make_schedule(ddim_num_steps=S, ddim_eta=eta, verbose=verbose)
        # sampling
        C, H, W = shape
        size = (batch_size, C, H, W)
    ...
    def resample_sampling(self, measurement, measurement_cond_fn, cond, shape, operator_fn=None,
        ...
        for i, step in enumerate(iterator):   
            ...
            index_split_latent = int(total_steps * 0.58333)
            print('index_split_latent', index_split_latent)
            ...
            if index <= (total_steps - index_split) and index > 0:   
                ...
                if index % 10 == 0 :  
                    ...
                    # Latent-based optimization in last stage
                    elif index < index_split_latent:
