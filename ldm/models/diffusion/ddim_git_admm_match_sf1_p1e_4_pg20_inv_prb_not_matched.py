...
class DDIMSampler(object):
            ...
            if index < phy_steps:   
                ...
                if index % 20 == 0 :
                    ...
                    if i >= 0:
                        ...
                        opt_var = self.model.encode_first_stage(opt_var)
    ...
    def pixel_optimization(self, measurement, x_prime, operator_fn, eps=1e-3, max_iters=100):
        ...
        rho = 1e-4 # rho changed to 1e-6 from 1e-3
        ...
        for _ in range(max_iters):
            ...
            measurement_loss = loss(measurement, operator_fn(opt_var)) + ((rho/2)*loss(x_prime, opt_var))
